        ...
        for line in tqdm(lines, desc="Ingesting documents", unit="doc", file=sys.stderr):
            try:
                ...
                if "SpecialtyId" in data:
                    document_id = f'specialty_{data["Id"]}'
...
def main():
    ...
    location = "global"
    datastore_name = "hhc-datastore-specialty-rollup-v1"
    engine_name = "hhc-query-app-specialty-rollup-v1"
    gcs_bucket = "hhc-bucket-dev"
    gcs_file = "transformed-data/transformed_rollup_data.jsonl"
